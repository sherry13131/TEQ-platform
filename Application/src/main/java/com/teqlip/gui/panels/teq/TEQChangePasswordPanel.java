...
public class TEQChangePasswordPanel extends BodyPanel {
  ...
  public JPasswordField[] textFields = new JPasswordField[TEQChangePasswordPanel.CHANGE_FIELDS.length];
  
  public TEQChangePasswordPanel(AppFrame main) {
    super(main);
  ...
  public JComponent createFieldsPane() {
    ...
    for (int i = 0; i < TEQChangePasswordPanel.CHANGE_FIELDS.length; i++) {
        JLabel label = new JLabel(TEQChangePasswordPanel.CHANGE_FIELDS[i]);
